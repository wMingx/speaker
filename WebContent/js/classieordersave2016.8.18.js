   ...
   showLoading();
    ...
    {			
        ...
        try{						
            ...
            var person="code="+getURLParameter("machineCode")+"&t="+timestamp3;	
                
                xmlhttp=null;
                postloadXMLDoc("manager/testoverview/selscttestoverview",person,function()			
                {			
                    if (xmlhttp.readyState==4 && xmlhttp.status==200)
                    {			
                        var myobj=eval(xmlhttp.responseText);  
                        try{
                            ...
                            if(myobj.length==0)
                            {
                            /*insert into 整机测试记录日志  
                                (首次测试人员,测试编码 ,首次测试结果 ,首次测试用例,首次测试时间 ,最后测试时间 ,
                                最后测试人员 ,最后测试用例 ,最后测试结果    )
                                values
                                    (#{firstTestName},
                                    #{code},
                                    #{firstTestResult},
                                ...
                                urllink="manager/testoverview/inserttestoverview";
                                ...
                                person="code="+getURLParameter("machineCode")+"&firstTestResult="+roidnumber
                                +"&firstTestEX="+"手动测试"
                                +"&firstTestTime="+getNowFormatDate()
                                +"&lastTestTime="+getNowFormatDate()
                                +"&lastTestEX="+"手动测试"
                                +"&lastTestResult="+roidnumber                    
                                +"&t="+timestamp3;
                            ...
                            }else
                            {
                                ...
                                urllink="manager/testoverview/updatetestoverview";
                                
                                person="code="+getURLParameter("machineCode")                    
                                +"&lastTestTime="+getNowFormatDate()
                                +"&lastTestEX="+"手动测试"
                                +"&lastTestResult="+roidnumber                    
                                +"&t="+timestamp3;
                            ...
                            {			
                                ...
                                {			
                                    ...
                                    urllink="manager/testrecord/inserttestrecord";
                                ...
                                /* insert into test_record 
                                    ...
                                    person="code="+getURLParameter("machineCode")                    
                                    +"&model="+"手动测试"                        
                                    +"&testResults="+roidnumber 
                                    +"&oldtesttime="+STRINGoldtime                                           
                                    +"&t="+timestamp3;                            
